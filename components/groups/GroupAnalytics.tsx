  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <StatisticCard title="Avg members / group" value={analytics.avgMembersPerGroup.toFixed(1)} />
        <StatisticCard title="Avg publications / group" value={analytics.avgPublicationsPerGroup.toFixed(1)} />
        <StatisticCard title="Avg events / group" value={analytics.avgEventsPerGroup.toFixed(1)} />
