...
import type { EditorialStructureMember } from '@/types/identity';

type EditorialBoardCardProps = {
  member: EditorialStructureMember;
  className?: string;
};

export default function EditorialBoardCard({ member, className = '' }: EditorialBoardCardProps) {
  return (
